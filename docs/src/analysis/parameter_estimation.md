...
Parameter estimation for differential equation models, also known as dynamic data analysis, is provided by the DiffEq suite. In this introduction, we briefly
...
- [DiffEqBayes.jl](https://github.com/SciML/DiffEqBayes.jl)

We also provide information regarding the respective strengths of these packages
so that you can easily decide which one suits your needs best. After the overviews of the abovementioned packages, we focus on describing the basics of DiffEqParamEstim.jl and DiffEqBayes.jl.
...
This package belongs to the DifferentialEquations ecosystem. Among other features,
it allows for the optimization of parameters in ODEs, stochastic problems, and
delay differential equations. The details are presented below.
...
conjunction with [Turing.jl](https://turing.ml/), [CmdStan.jl](https://github.com/StanJulia/CmdStan.jl), [DynamicHMC.jl](https://github.com/tpapp/DynamicHMC.jl), and [ApproxBayes.jl](https://github.com/marcjwilliams1/ApproxBayes.jl).

## Installation

The functionality offered by DiffEqParamEstim.jl and DiffEqBayes.jl does not come standard with DifferentialEquations.jl.
