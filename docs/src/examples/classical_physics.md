...
import OrdinaryDiffEq as ODE
import OrdinaryDiffEqRKN: DPRKN6
import Plots: plot, plot!
...
function poincare_map(prob, u₀, p; callback = cb)
    ...
    return scatter!(p, sol, idxs = (3, 4), markersize = 3, msw = 0)
end
```
