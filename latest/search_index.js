...

{
    ...
    "title": "Example",
    "category": "section",
    "text": "using DifferentialEquations, Plots\nlorenz = @ode_def begin\n  dx = σ*(y-x)\n  dy = ρ*x-y-x*z\n  dz = x*y-β*z\nend σ β ρ\nu0 = [1., 5., 10.]\ntspan = (0., 100.)\np = (10.0,8/3,28.0)\nprob = ODEProblem(lorenz, u0, tspan,p)\nsol = solve(prob)\nxyzt = plot(sol, plotdensity=10000,lw=1.5)(Image: lorenz_plot)An example using the functions:f(x,y,z) = (sqrt(x^2+y^2+z^2),x)\nplot(sol,vars=(f,:x,:y,:z))(Image: norm_plot)"
},
...
{
    "location": "analysis/parameter_estimation.html#build*loss*objective-1",
    "page": "Parameter Estimation",
    "title": "buildlossobjective",
    "category": "section",
...

{
    ...
    "page": "Parameter Estimation",
    "title": "multipleshootingobjective",
    "category": "section",
