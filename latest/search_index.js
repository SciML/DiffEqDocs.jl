...

{
    ...
    "category": "section",
    "text": "Quasi-constant stepping is the time stepping strategy which matches the classic GEAR and LSODE integrators. The variable-coefficient methods match the ideas of the classic EPISODE integrator. The Fixed Leading Coefficient (FLC) methods match the behavior of the classic VODE and Sundials CVODE integrator.QNDF1 - An adaptive order 1 quasi-constant timestep L-stable numerical differentiation function (NDF) method. Optional parameter kappa defaults to Shampine\'s accuracy-optimal -0.1850.\nQBDF1 - An adaptive order 1 quasi-constant timestep L-stable BDF method. This is equivalent to implicit Euler but using the BDF error estimator with quasi-constant stepping.\nABDF2 - An adaptive order 2 L-stable fixed leading coefficient multistep BDF method.\nQNDF2 - An adaptive order 2 quasi-constant timestep L-stable numerical differentiation function (NDF) method. Optional parameter kappa defaults to Shampine\'s accuracy-optimal -1/9.\nQBDF2 - An adaptive order 2 quasi-constant timestep L-stable BDF method.\nQNDF - An adaptive order quasi-constant timestep NDF method. Utilizes Shampine\'s accuracy-optimal kappa values as defaults (has a keyword argument for a tuple of kappa coefficients). In development.\nJVODE_BDF - An adaptive time adaptive order fixed-leading coefficient BDF method in Nordsieck form. In development."
},
