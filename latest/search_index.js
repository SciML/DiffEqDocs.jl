...

{
    ...
    "title": "Limitations",
    "category": "section",
    "text": "The macro is a DSL and thus has different internal semantics than standard Julia functions. In particular:Control sequences and conditionals (while, for, if) will not work in the macro.\nIntermediate calculations (likes that don't start with d_) are incompatible with the Jacobian etc. calculations.\nThe macro has to use t for the independent variable."
},
